...
import com.fivefour.ynote.adapters.NotesAdapter;
import com.fivefour.ynote.callbacks.MainActionModeCallback;
...
import com.fivefour.ynote.utils.Developer;
...
import static com.fivefour.ynote.EditeNoteActivity.NOTE_EXTRA_KEY;
...
public class MainActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
    ...
    private void setupNavigation(Bundle savedInstanceState, Toolbar toolbar) {
        ...
        iDrawerItems.add(new PrimaryDrawerItem().withName("Version").withIcon(R.drawable.ic_version_foreground));
        iDrawerItems.add(new PrimaryDrawerItem().withName("About App").withIcon(R.drawable.ic_aboutapp_foreground));
        iDrawerItems.add(new PrimaryDrawerItem().withName("Contact Developer").withIcon(R.drawable.ic_contactd_foreground));
        ...
        AccountHeader header = new AccountHeaderBuilder().withActivity(this)
                .addProfiles(new ProfileDrawerItem()
                        .withEmail("rk47c4@gmail.com")
                        .withName("54Enterprises")
                        .withIcon(R.mipmap.ic_bus_one))
